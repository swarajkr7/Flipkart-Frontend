...
const ProductDetail = ({product}) =>{
    ...
    return (
        ...
        <Typography>{product.title.longTitle}</Typography>
          ...
          <Typography>Avaialable Offers</Typography>
          <SmallText>
            ...
            <Typography><StyledBadge/>Sign ip for Flipkart Pay Later and get Flipkart Gift Card worth ₹100* know More</Typography>
